...
class EnvmapMaterialNetwork(nn.Module):
    def __init__(self, multires=0, dims=[256, 256, 256],
        ...
        # dict_keys(['model.nodes.object.rendering_network.lin_pose.weight', 'model.nodes.object.rendering_network.lin_pose.bias', 
        # 'model.nodes.object.rendering_network.lin0.bias', 'model.nodes.object.rendering_network.lin0.weight_g', 'model.nodes.object.rendering_network.lin0.weight_v', 
        # 'model.nodes.object.rendering_network.lin1.bias', 'model.nodes.object.rendering_network.lin1.weight_g', 'model.nodes.object.rendering_network.lin1.weight_v', 
        # 'model.nodes.object.rendering_network.lin2.bias', 'model.nodes.object.rendering_network.lin2.weight_g', 'model.nodes.object.rendering_network.lin2.weight_v', 
        # 'model.nodes.object.rendering_network.lin3.bias', 'model.nodes.object.rendering_network.lin3.weight_g', 'model.nodes.object.rendering_network.lin3.weight_v', 
        # 'model.nodes.object.rendering_network.lin4.bias', 'model.nodes.object.rendering_network.lin4.weight_g', 'model.nodes.object.rendering_network.lin4.weight_v'])
        ...
        self.skin_color = nn.Parameter(torch.tensor([1.98, 0.73, -0.36]), requires_grad=True)
    ...
    def forward(self, points, w2c=None):
        if points is None:
            diffuse_albedo = None
        ...
        # specular_reflectacne = torch.ones_like(specular_reflectacne)*0.5

        roughness = torch.sigmoid(self.roughness)
        # print('roughness: ', roughness.clone().detach().cpu().numpy())
        # print('specular_reflectacne: ', specular_reflectacne.clone().detach().cpu().numpy())
        # exit()
