...
class Node(nn.Module):
    ...
    def forward(self, input, node_right=None, node_left=None):
        ...
        color, normal, semantics = self.render(
            sample_dict, num_samples, canonical_points, feature_vectors, time_code, self.node_id, node_right, node_left
        )
    ...
    def render(
        self, sample_dict, num_samples, canonical_points, feature_vectors, time_code, node_id, node_right, node_left
    ):
