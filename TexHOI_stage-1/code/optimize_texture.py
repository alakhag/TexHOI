...
from src.hold.hold2 import HOLD_stage2
...
def main():
    ...
    if args.load_ckpt != "":
        ...
        # print (model.model.nodes["object"].rendering_network.envmap_material_network.brdf_layer.lin4.bias.shape)
        # print (model.model.nodes["object"].rendering_network.envmap_material_network.brdf_layer.lin4.weight_g.shape)
        # print (model.model.nodes["object"].rendering_network.envmap_material_network.brdf_layer.lin4.weight_v.shape)
        # print (object_renderinh_lin4["lin4.bias"].shape)
        # print (object_renderinh_lin4["lin4.weight_g"].shape)
        # print (object_renderinh_lin4["lin4.weight_v"].shape)
